...
{
    public partial class BloodDonorGroupForm : Form
    {
        string name;
        string nid;
        string phone;
        string address;
        string password;
        public BloodDonorGroupForm(string name, string nid, string phone, string address, string password)
        {
            InitializeComponent();
            this.name = name;
            this.nid = nid;
        ...
        private void BloodDonorGroupForm_Load(object sender, EventArgs e)
        {
        ...
        private void Next_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int number = oproduct.insertBloodDonor(eproduct);
                this.Hide();
